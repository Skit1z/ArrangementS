...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.dialects.postgresql.ENUM("pending", "approved", "rejected", "withdrawn", "cancelled", "expired", "awaiting_target", "open_collecting", "pending_admin", name="request_status", create_type=False), nullable=False, server_default="pending"),
